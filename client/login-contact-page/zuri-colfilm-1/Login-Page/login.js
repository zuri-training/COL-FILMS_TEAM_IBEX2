...
// window.location = "/COL-FILMS_TEAM_IBEX2/client/Home-Signup-Trending pages/homepage1.html"; // Redirecting to other page.
// return false;
// }
// else{
...
async function login(e) {
  ...
  fetch("http://localhost:6100/api/auth/login", {
    method: "POST",
